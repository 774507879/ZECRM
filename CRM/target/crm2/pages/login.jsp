...
<html>
  ...
  <div class="layui-layout">
        ...
        <!--<i class="layui-icon">&#xe613;</i>
          ...
          <div class="layui-form-item">
            <div class="layui-input-block">
                ...
                <button style="margin-top: 10px; type="register" class="layui-btn layui-btn-default" id="registerButton" lay-submit lay-filter="loginForm">
                <i class="layui-icon">စ</i>&nbsp;注册账号
                </button>
            </div>
          </div>   
    ...
    $("#registerButton").click(function () {
     window.alert("暂时不支持注册,如要使用请联系管理员添加账户,管理员邮箱774507879@qq.com")
    })
